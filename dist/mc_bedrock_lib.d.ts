...
import { Entity, EquipmentSlot, ItemStack, Player, ScriptEventCommandMessageAfterEventSignal, System, WeatherType, World, WorldAfterEvents, WorldBeforeEvents } from '@minecraft/server';
...
export declare function clampValue(num: number, min: number, max: number): number;
